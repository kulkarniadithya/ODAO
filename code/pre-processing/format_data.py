...
if __name__ == "__main__":
    read_path = "../../data/original_data/SemEval14-Restaurant/test.xml"
    write_path = "../../data/processed_data/SemEval14-Restaurant/sentence_dictionary_test.pickle"
